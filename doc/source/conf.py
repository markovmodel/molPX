...
# -*- coding: utf-8 -*-
#
# Projection Explorer documentation build configuration file, created by
...
MOCK_MODULES = ['mdtraj', 'pyemma', 'matplotlib', 'scipy', 'numpy', 'pandas']
...
# Add any projection_paths that contain custom themes here, relative to this directory.
# html_theme_path = []

# The name for this set of Sphinx documents.
# "<project> v<release> documentation" by default.
#
# html_title = 'Projection Explorer v0'
...
# Add any projection_paths that contain custom static files (such as style sheets) here,
# relative to this directory. They are copied after the builtin static files,
# so a file named "default.css" will overwrite the builtin "default.css".
#html_static_path = ['_static']

# Add any extra projection_paths that contain custom files (such as robots.txt or
...
htmlhelp_basename = 'ProjectionExplorerdoc'
...
latex_documents = [
    (master_doc, 'ProjectionExplorer.tex', 'Projection Explorer Documentation',
     'Guillermo Pérez-Hernández', 'manual'),
]
...
man_pages = [
    (master_doc, 'projectionexplorer', 'Projection Explorer Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ProjectionExplorer', 'Projection Explorer Documentation',
     author, 'ProjectionExplorer', 'One line description of project.',
     'Miscellaneous'),
]
