...
`cannot be stored <https://github.com/arose/nglview/issues/37>`_ currently in the notebook file.
In short: this html-notebook is lacking the most visually appealing part of projX. Please check
the :doc:`Youtube video </about>`  or the :doc:`gif animation </index>` to see `projX` in action.
